 ...
 * Generated at: 2016-08-07 16:37:38 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel-heading\">Operation</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"btnrestore\">Restore</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-lg btn-block\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"btnbackup\">Backup</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label>File</label> <input id=\"filep\" type=\"file\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <form class=\"col-lg-12\" action=\"../uploadfile.nk\" method=\"post\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tenctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"file\" name=\"file\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-warning btn-lg btn-block\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"btnrestore\">Restore</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-lg btn-block\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"btnbackup\">Backup</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<form id=\"fileup\" action=\"../uploadfile.nk\" method=\"post\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tenctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\tSelect File : <input type=\"file\" name=\"filetoupload\"> <br />\r\n");
